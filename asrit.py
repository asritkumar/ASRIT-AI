...
========================================================= */
:root{
  --background:linear-gradient(145deg,#dff5ff 0%,#f7fbff 48%,#d9efff 100%);
  --glass:rgba(255,255,255,.58); --glass-strong:rgba(255,255,255,.78);
  --border:rgba(72,120,155,.18); --text:#17354b; --muted:#58748a;
  --accent:#2677ff; --accent2:#20bde9; --danger:#d94a5c;
}
